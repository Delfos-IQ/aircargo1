...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'awb-stock', label: 'AWB Stock', path: '/awb-stock', adminOnly: true,
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'rates', label: 'Rates', path: '/rates', adminOnly: true,
  ...
  },
  {
    label: 'Master Data',
    items: [
      { id: 'agents', label: 'Agents', path: '/agents', adminOnly: true,
      ...
      { id: 'gha', label: 'GHA Profiles', path: '/gha', adminOnly: true,
      ...
      { id: 'airports', label: 'IATA Airports', path: '/airports', adminOnly: true,
...
export default function Layout({ children }) {
  ...
  const { currentUserProfile, logout, isAdmin } = useAppContext();
