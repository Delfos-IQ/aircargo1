...
// roles: array of roles that can see this item. If omitted, all authenticated users see it.
...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'awb-stock', label: 'AWB Stock', path: '/awb-stock', roles: ['admin', 'operator'],
      ...
      { id: 'flights', label: 'Flights', path: '/flights', roles: ['admin', 'operator'],
  ...
  },
  {
    label: 'Finance',
    items: [
      { id: 'billing', label: 'Billing', path: '/billing', roles: ['admin'],
      ...
      { id: 'rates', label: 'Rates', path: '/rates', roles: ['admin', 'operator'],
  ...
  },
  {
    label: 'Master Data',
    items: [
      { id: 'agents', label: 'Agents', path: '/agents', roles: ['admin', 'operator'],
      ...
      { id: 'gha', label: 'GHA Profiles', path: '/gha', roles: ['admin', 'operator'],
      ...
      { id: 'airports', label: 'IATA Airports', path: '/airports', roles: ['admin', 'operator'],
    ...
    <div className="app-shell">
      ...
      <aside className={`sidebar${mobileOpen ? ' open' : ''}`}>
        <div className="sidebar-logo">
          <img src="/logo.svg" alt="AcrossCargo" style={{ height: 40, width: 'auto', flexShrink: 0 }} />
        </div>
