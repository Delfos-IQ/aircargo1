...
export default function DashboardPage() {
  ...
  const { bookings, agentProfiles, flightSchedules, awbStockAllocations, currentUserProfile, isAdmin, myAgentId } = useAppContext();
  ...
  const allModules = [
    ...
    { title: 'AWB Stock', path: '/awb-stock', color: 'amber', adminOnly: true, description: 'Manage AWB stock batches and agent allocations',
    ...
    { title: 'Agents', path: '/agents', color: 'purple', adminOnly: true, description: 'Freight agent profiles with IATA/CASS data',
    ...
    { title: 'Rates', path: '/rates', color: 'orange', adminOnly: true, description: 'Rate table by route with weight-break pricing',
    ...
    { title: 'GHA Profiles', path: '/gha', color: 'pink', adminOnly: true, description: 'Ground Handling Agents: names, abbreviations and locations',
    ...
    { title: 'IATA Airports', path: '/airports', color: 'slate', adminOnly: true, description: 'IATA airport codes for routes and autocomplete',
    ...
    { title: 'Users', path: '/users', color: 'lime', adminOnly: true, description: 'System user management with roles and permissions',
  ...
  const modules = allModules.filter(m => isAdmin || !m.adminOnly);
